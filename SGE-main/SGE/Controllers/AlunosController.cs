...
namespace SGE.Controllers
{
	public class AlunosController : Controller
	{
		...
		public async Task<IActionResult> AlterarFoto(Guid id, IFormFile novafoto)
		{
			...
			{
				var fileName = aluno.AlunoId.ToString(); //Gera um novo nome para imagem
				var fileExtension = Path.GetExtension(novafoto.FileName); //pega a extensao do arquivo
				var newFileName = fileName + fileExtension; //Nova nome do arquivo
				var filePath = Path.Combine(Directory.GetCurrentDirectory(),
				   "Data\\Content\\Photo", newFileName);
